...
async function createRecord(type: string, data: Record<string, unknown>) {
  switch (type) {
    case "staff":
      ...
      break;
    case "assets":
      await prisma.asset.create({ data: data as any });
      break;
    case "inventory":
      await prisma.inventoryItem.create({ data: data as any });
      break;
    case "tickets":
      await prisma.ticket.create({ data: data as any });
      break;
    case "vendors":
      await prisma.vendor.create({ data: data as any });
      break;
    case "licenses":
      await prisma.softwareLicense.create({ data: data as any });
      break;
    case "knowledge-base":
      await prisma.knowledgeBaseArticle.create({ data: data as any });
      break;
    case "backups":
      await prisma.backupRecord.create({ data: data as any });
      break;
    case "budgets":
      await prisma.budget.create({ data: data as any });
      break;
    case "notifications":
