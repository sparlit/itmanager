...
const navItemsSecondary = [
  { id: "changes" as const, label: "Changes", icon: GitBranch, description: "Change management" },
  { id: "time-tracking" as const, label: "Time Tracking", icon: Clock, description: "Log hours" },
...
const allNavItems = [...navItems, ...navItemsSecondary, ...navItemsAdmin];
...
export function AppSidebar() {
  ...
  }, [sidebarOpen, setSidebarOpen, cancelExpandTimer]);
      ...
      >
        ...
        <div className="p-2.5">
          ...
          <Button
            ...
            className={cn(
              "w-full text-slate-500 hover:text-slate-300 hover:bg-slate-800/50 rounded-lg",
