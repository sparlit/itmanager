  ...
  return (
    <motion.div className="space-y-5" variants={containerVariants} initial="hidden" animate="show">
      <motion.div variants={itemVariants} viewport={{ once: true }}>
        <div><h1 className="text-[20px] font-bold tracking-tight text-slate-900">Audit Log</h1><p className="text-[13px] text-slate-500 mt-0.5">System-wide activity tracking and change history</p></div>
      </motion.div>
