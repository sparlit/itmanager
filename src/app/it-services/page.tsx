  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold text-slate-900 mb-6">IT Services Catalogue</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {IT_SERVICES.map((svc) => (
            <Card key={svc.id} className="h-full border-0 shadow-lg rounded-2xl overflow-hidden hover:shadow-2xl transition-all">
        ...
        <div className="mt-6 flex justify-center">
          <Button>Request IT Service</Button>
        </div>
      </div>
    </div>
  )
