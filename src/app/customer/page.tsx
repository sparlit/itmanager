      ...
      <nav className="relative z-10 border-b border-slate-800/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-6">
              <Link href="/customer/orders" className="text-slate-300 hover:text-white transition-colors">My Orders</Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-slate-800/50 px-4 py-4 space-y-3">
            <Link href="/customer/orders" className="block text-slate-300 hover:text-white">My Orders</Link>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
        <div className="text-center">
          ...
          >
            ...
            <Link href="/customer/orders" className="px-8 py-4 rounded-xl border border-slate-700 text-white font-semibold text-lg hover:bg-slate-800/50 transition-all flex items-center gap-2">
              My Orders
